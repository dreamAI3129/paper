...
}catch(e){console.error("An error has occurred. [ File: https://thectoclub.com/wp-content/plugins/gravityformsgoogleanalytics/js/google-analytics.min.js ] [ "+e.stack+" ]");}
